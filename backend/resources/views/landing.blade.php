...
<body>
    ...
    <body>
                ...
                <form id="org-form" class="org-form">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="assessor-name" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="assessor-position">Jabatan Assessor *</label>
                            <input type="text" id="assessor-position" class="form-control" required>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Tools Assessment</h2>
                <p class="section-subtitle">Evaluasi tingkat kematangan digital government secara mandiri</p>
            </div>
            <div class="assessment__options">
                <div class="assessment-card" data-assessment="spbe">
                    <div class="assessment-header">
                        <h3>Assessment SPBE</h3>
                        <div class="assessment-badge">47 Indikator</div>
                    </div>
                    <p>Evaluasi komprehensif berdasarkan Peraturan Menteri PANRB tentang SPBE</p>
                    <div class="assessment-domains">
                        <div class="domain-item">
                            <span class="domain-name">Kebijakan Internal SPBE</span>
                            <span class="domain-count">12 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Tata Kelola SPBE</span>
                            <span class="domain-count">13 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Manajemen SPBE</span>
                            <span class="domain-count">8 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Layanan SPBE</span>
                            <span class="domain-count">14 indikator</span>
                        </div>
                    </div>
                    <button class="btn btn--primary btn--full-width" onclick="startAssessment('spbe')">
                        Mulai Assessment SPBE
                    </button>
                </div>

                <div class="assessment-card" data-assessment="digital-gov">
                    <div class="assessment-header">
                        <h3>Assessment Pemerintahan Digital</h3>
                        <div class="assessment-badge">32 Indikator</div>
                    </div>
                    <p>Evaluasi berdasarkan framework Pemerintahan Digital 2025-2029</p>
                    <div class="assessment-domains">
                        <div class="domain-item">
                            <span class="domain-name">Digital Leadership</span>
                            <span class="domain-count">8 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Digital Infrastructure</span>
                            <span class="domain-count">8 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Digital Services</span>
                            <span class="domain-count">8 indikator</span>
                        </div>
                        <div class="domain-item">
                            <span class="domain-name">Digital Security & Governance</span>
                            <span class="domain-count">8 indikator</span>
                        </div>
                    </div>
                    <button class="btn btn--primary btn--full-width" onclick="startAssessment('digital-gov')">
                        Mulai Assessment Pemerintahan Digital
                    </button>
                </div>
            </div>
        </div>
